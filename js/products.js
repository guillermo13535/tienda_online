/* =========================================================
   ...
   Este archivo es la ÚNICA fuente de datos de productos.
   ========================================================= */
...
const PRODUCTS = [
  ...
  {
    id: 4,
    name: "Audífonos Gamer HP DHE-8011",
    category: "gamer",
    price: 39990,
    rating: 4,
    badge: "OFERTA",
...
// Categorías disponibles para los filtros (clave -> etiqueta)
const CATEGORIES = {
  all: "Todos",
